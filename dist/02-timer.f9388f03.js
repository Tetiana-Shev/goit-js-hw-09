...
const options = {
    ...
    onClose (selectedDates) {
        ...
        if (selectedDatesUTC <= dateNow) (0, _notiflixDefault.default).Notify.failure("Please choose a date in the future");
...
function timerStart() {
    const timeId = setInterval(()=>{
        ...
        if (days === 0 && hours === "00" && minutes === "00" && seconds === "00") clearInterval(timeId);
    }, 1000);
}
